...
1. Try: `'Lab Data Logger Version ' + 1.0` (this will cause an error)
2. Try: `'Lab Data Logger Version ' + str(1.0)` (this will work)
3. Understand why the first approach fails and the second succeeds

**Expected output:**

```
The title of this app is Lab Data Logger Version 1.0
```
...
3. Create an interactive program that:
   ...
   - Combines the name with a version number (e.g. for a lab data logger)
